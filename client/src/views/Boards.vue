        ...
        <v-flex v-if="!loading" sm3 v-for="board in boards" :key="board._id" pa-2>
          <v-card>
            ...
            <v-card-title primary-title>
             ...
             <v-card-actions>
                <v-btn color="primary" :to="{ name: 'board', params: { id: board._id } }">Details</v-btn>
              </v-card-actions>
          </v-card>
        </v-flex>
      ...
      <v-card>
        <v-card-title primary-title style="flex-direction: column">
          ...
          <div>
            ...
            <v-progress-circular v-if="creating" :size="70" :width="7" indeterminate color="primary"></v-progress-circular>
          </div>
        </v-card-title>
      </v-card>
    </v-flex>
